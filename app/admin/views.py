...
from app.admin.forms import LoginForm, TagForm, MovieForm, PreviewForm, PwdForm, AutoForm,RoleForm,AdminForm
from app.models import Admin, Tag, Movie, Preview, User, Comment, Moviecol,Role, Oplog, Adminlog, Userlog, Auth
...
def movie_add():
    ...
    if form.validate_on_submit():
        ...
        if not os.path.exists(app.config["UP_DIR"]):
            ...
            os.chmod(app.config["UP_DIR"], 0o700)
